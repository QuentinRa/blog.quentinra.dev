# Git files/server-side features...

<div class="row row-cols-md-2"><div>

You can find notes about Git [here](/_it/dev/git/index.md). Here, I will assume that you're already familiar with Git, and you will notes about stuff like
...
Additional notes for open source projects.

...
sudo apt update aptitude  #search for an upgrade
...
Remark : you may also try the `--help` flag.

</details>

<details class="details-e">
<summary><code>whatis</code>: a short description of a command from the manual</summary>

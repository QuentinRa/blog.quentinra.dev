...
La langue japonaise possède 3 jeux de lettres :

.. toctree::
		:maxdepth: 1

			Kanji                     <alphabet/kanji>
			Hiragana et Katakana      <alphabet/kana>
			Rōmaji                    <alphabet/romaji>
...
sont réalisés par des **particules** que l'on retrouve entre chaque mots.
	...
	* **ni** (に) pour indiquer un moment ou un lieu/direction (moment/lieu **ni** ... verbe)
...
**Crédits**
	* Chizuru KITAI (enseignante à l'ENSIIE)

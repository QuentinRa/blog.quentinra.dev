...
Le SQL est un langage relationnel, tout le vocabulaire associé
est décrit dans le cours de modélisation relationnelle (:ref:`relation`).
...
5. Création de table et de vues
=========================================

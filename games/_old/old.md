...
If you are **unfamiliar** with GitHub/Git, you may read the [GIT course](../../tools/git/index.md). Unfortunately, for a non-programmer, this may be complex, my advice is to [create a repository](https://docs.github.com/en/get-started/quickstart/create-a-repo) (ex: on GitHub) and continue reading while relying on Stack Overflow/...

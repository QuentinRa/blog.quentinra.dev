...
To create a group, create a new game object, inside another one. You can drag and drop an existing object inside another game object.

![Hierarchy - groups](images/groups.png)

> **Tip 1**: Sometimes, we are using an "Empty Game objects" as the parent to sort things.<br>
> **Tip 2**: If you are hiding the parent, the children are also hidden. This is useful, but if this is not what you want, you can simply prevent the parent from being rendered (by disabling its rendered).
</details>

...
.. math::
		...
		1.\lim_{x \rightarrow +\infty} \frac{x-2}{x^2+x+1} \ \ \ \ \ \ \ \
		2.\lim_{x \rightarrow 3^-} \frac{1-x^2}{x^2-7x+12} \\
		3.\lim_{x \rightarrow -\infty} \frac{1-x^2}{3x+2} \ \ \ \ \ \ \ \
		4.\lim_{x \rightarrow 3} \frac{2-x}{x^2-6x+9}  \\
		5.\lim_{x \rightarrow +\infty} exp(x)+cos(x)\ \ \ \ \ \ \ \
		6.\lim_{x \rightarrow 2} \frac{x-2}{x^2-3x+2}

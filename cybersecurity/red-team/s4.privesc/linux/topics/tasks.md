...
But, there is another way to find users' cron tasks. You can monitor Linux processes, for instance, using [pspy](https://github.com/DominicBreuker/pspy) <small>(5.3k ⭐)</small> which can monitor Linux processes without root permissions.

...
[ComplianceAsCode/content](https://github.com/ComplianceAsCode/content) <small>(2.0k ⭐)</small> is a tool to create a product-specific XML <small>(ssg-debian11-ds.xml)</small> used by **OpenSCAP** 🔎.

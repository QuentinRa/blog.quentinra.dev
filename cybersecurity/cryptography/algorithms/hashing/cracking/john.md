...
[John the Ripper](https://github.com/openwall/john) <small>(11.0k ⭐, Jumbo)</small>, a.k.a. **john**/**JtR** is, like hashcat, a tool to crack hashes. For convenience's sake, we store the hash in `myhash`.

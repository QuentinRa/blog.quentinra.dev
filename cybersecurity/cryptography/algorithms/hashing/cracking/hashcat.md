...
[hashcat](https://github.com/hashcat/hashcat) <small>(22.2k ⭐)</small> is a well-known, and popular tool to crack passwords. For convenience’s sake, we store the hash in a file `hash`.
